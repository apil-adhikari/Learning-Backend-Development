...
// This file is used to send alerts
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /*eslint-disable*/ // Using installed axios
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          (0, _alerts.showAlert)('error', "".concat(_context.t0.response.data.message, " \u2639\uFE0F"));
        case 13:
        case "end":
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, photo, role, password, passwordConfirm) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          (0, _alerts.showAlert)('error', "".concat(((_error$response = _context.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || 'Signup failed!', " \u274C"));
        case 14:
        case "end":
          return _context.stop();
      }
...
var signupForm = document.querySelector('.form--signup'); // For signup form
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(name, email, photo, role, password, passwordConfirm);
  });
}
